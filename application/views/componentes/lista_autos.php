<ul class="collection">
    ...
    <li class="collection-item">
        <div>
            ...
            <a href="#!" class="tooltipped secondary-content" data-position="bottom" data-delay="50" data-tooltip="Editar"><i class="material-icons">edit</i></a>
            <a href="<?php echo base_url('vehiculo/ver/') . $f['placa']; ?>" class="tooltipped secondary-content" data-position="bottom" data-delay="50" data-tooltip="Ver"><i class="material-icons">content_paste</i></a>
        </div>
    </li>
    <?php endforeach; ?>
</ul>
